...
@Component({
  selector: 'notaContablePorAdjunto',
  templateUrl: './notaContablePorAdjunto.component.html',
  styleUrls: ['./notaContablePorAdjunto.css']
})
export class notaContablePorAdjuntoComponent {
