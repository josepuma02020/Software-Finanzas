...
namespace Infraestructure.Migrations
{
    ...
    [Migration("20230313215333_Migration5")]
            ...
            modelBuilder.Entity("Domain.Aplicacion.ConfiguracionServicios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd8a0338-3c52-4910-b1ab-ecafd781d717"),
                            Activo = true,
                            FechaDeCreacion = new DateTime(2023, 3, 13, 16, 53, 31, 517, DateTimeKind.Local).AddTicks(7400),
                            Servicio = "Facturas"
                        },
                        new
                        {
                            Id = new Guid("38dba2d9-223b-4e0a-b61b-1b8d2c2b80f4"),
                            Activo = true,
                            FechaDeCreacion = new DateTime(2023, 3, 13, 16, 53, 31, 517, DateTimeKind.Local).AddTicks(7458),
                            Servicio = "Notas Contables"
                        },
                        new
                        {
                            Id = new Guid("11a97d55-e1e1-4dc8-a931-9d31c77b98d1"),
                            Activo = true,
                            FechaDeCreacion = new DateTime(2023, 3, 13, 16, 53, 31, 517, DateTimeKind.Local).AddTicks(7463),
            ...
            modelBuilder.Entity("Domain.Documentos.ConceptoFactura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("847bf73a-56d4-4c67-a5cb-209a54c90a9d"),
                            Concepto = "RI",
                            FechaDeCreacion = new DateTime(2023, 3, 13, 16, 53, 31, 517, DateTimeKind.Local).AddTicks(7831)
                        });
                });
