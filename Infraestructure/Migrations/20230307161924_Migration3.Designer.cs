...
namespace Infraestructure.Migrations
{
    ...
    [Migration("20230307161924_Migration3")]
            ...
            modelBuilder.Entity("Domain.Aplicacion.ConfiguracionServicios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6704bfdb-46a8-4c1e-b3b7-14b89c788f02"),
                            Activo = true,
                            FechaDeCreacion = new DateTime(2023, 3, 7, 11, 19, 24, 116, DateTimeKind.Local).AddTicks(3898),
                            Servicio = "Facturas"
                        },
                        new
                        {
                            Id = new Guid("78b26555-959a-4eee-94ab-1649666c1650"),
                            Activo = true,
                            FechaDeCreacion = new DateTime(2023, 3, 7, 11, 19, 24, 116, DateTimeKind.Local).AddTicks(3964),
                            Servicio = "Notas Contables"
                        },
                        new
                        {
                            Id = new Guid("48d1127e-2cc7-4098-9eee-9e9a51beb4b6"),
                            Activo = true,
                            FechaDeCreacion = new DateTime(2023, 3, 7, 11, 19, 24, 116, DateTimeKind.Local).AddTicks(3968),
            ...
            modelBuilder.Entity("Domain.Documentos.ConceptoFactura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6089896c-116a-424d-b308-ab4e2522af32"),
                            Concepto = "RI",
                            FechaDeCreacion = new DateTime(2023, 3, 7, 11, 19, 24, 116, DateTimeKind.Local).AddTicks(4333)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<Guid>("UsuarioAsignaProcesoId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UsuarioAsignaProcesoId");
            ...
            modelBuilder.Entity("Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Usuario", "UsuarioAsignaProceso")
                        .WithMany("UsuariosqueAgregoProceso")
                        .HasForeignKey("UsuarioAsignaProcesoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("UsuarioAsignaProceso");
